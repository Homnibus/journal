...
function codex_search() {
    ...
    codex_list.filter(function(){return jq_contains_words(search_words,$(this).text());}).closest('.codex').show();
    codex_list.filter(function(){return !jq_contains_words(search_words,$(this).text());}).closest('.codex').hide();
}
