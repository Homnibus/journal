...
from projets.commun.utils import java_string_hashcode, create_or_get_today_page
from projets.fields import AuthorFilteredPrimaryKeyRelatedField
from projets.models import Codex, Page, Note, Task, Information, get_current_timestamp
...
class NoteCreateSerializer(HashSerializerMixin, serializers.ModelSerializer):
    ...
    def validate_codex(self, value):
        ...
        if not self.context['request'].user.has_perm('projets.change_codex', codex):
