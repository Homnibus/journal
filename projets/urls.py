...
urlpatterns = [
    ...
    path('codex/<slug:codex_slug>/information', views.information_view, name='information'),

    path('tasks', views.task_list_view, name='tasks'),
    path('codex/<slug:codex_slug>/tasks', views.task_list_filtered_view, name='codex_tasks'),
