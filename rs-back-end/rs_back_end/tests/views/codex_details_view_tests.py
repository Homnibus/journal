...
from rs_back_end.commun.codex import Page as Page_container
from rs_back_end.commun.error import HttpNotFound
from rs_back_end.forms import TaskUpdateForm, TaskCreateForm, NoteUpdateForm
from rs_back_end.models import Codex, Page, get_current_timestamp, Note, Task
from rs_back_end.views.codex_details_view import (
  get_today_page,
...
class GetTodayPageTest(TestCase):
  ...
  def test_get_today_page_exist_assert_return_page(self):
    ...
    self.assertIsInstance(page_container.tasks_form[0], TaskUpdateForm)
